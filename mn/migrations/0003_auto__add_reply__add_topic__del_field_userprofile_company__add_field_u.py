...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'mn_userprofile', 'company')

        # Adding field 'Userprofile.location'
        db.add_column(u'mn_userprofile', 'location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)


        # Changing field 'Userprofile.avatar'
        db.alter_column(u'mn_userprofile', 'avatar', self.gf('django.db.models.fields.CharField')(max_length=40))
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'mn_userprofile', 'company',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)

        # Deleting field 'Userprofile.location'
        db.delete_column(u'mn_userprofile', 'location')


        # Changing field 'Userprofile.avatar'
        db.alter_column(u'mn_userprofile', 'avatar', self.gf('django.db.models.fields.CharField')(max_length=30))
