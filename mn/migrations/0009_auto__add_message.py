...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mn_message', (
            ...
            ('from_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fromuser', to=orm['auth.User'])),
            ('to_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='touser', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 7, 2, 0, 0), blank=True)),
        ))
        db.send_create_signal(u'mn', ['Message'])


    def backwards(self, orm):
        # Deleting model 'Message'
        db.delete_table(u'mn_message')
