...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Collection.owner_user_topic'
        db.delete_column(u'mn_collection', 'owner_user_topic_id')

        # Deleting field 'Collection.owner_user'
        db.delete_column(u'mn_collection', 'owner_user_id')

        # Adding field 'Collection.user'
        db.add_column(u'mn_collection', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='owneruser', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Collection.topic'
        db.add_column(u'mn_collection', 'topic',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='ownerusertopic', to=orm['mn.Topic']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Collection.owner_user_topic'
        db.add_column(u'mn_collection', 'owner_user_topic',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='ownerusertopic', to=orm['mn.Topic']),
                      keep_default=False)

        # Adding field 'Collection.owner_user'
        db.add_column(u'mn_collection', 'owner_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='owneruser', to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'Collection.user'
        db.delete_column(u'mn_collection', 'user_id')

        # Deleting field 'Collection.topic'
        db.delete_column(u'mn_collection', 'topic_id')
    ...
    models = {
        ...
        u'mn.collection': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 2, 0, 0)', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'topic': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ownerusertopic'", 'to': u"orm['mn.Topic']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'owneruser'", 'to': u"orm['auth.User']"})
        },
        u'mn.follow': {
            'Meta': {'object_name': 'Follow'},
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 2, 0, 0)', 'blank': 'True'}),
            'followed': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'followed_user'", 'to': u"orm['auth.User']"}),
            'follower': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'follower_user'", 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'mn.message': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 2, 0, 0)', 'blank': 'True'}),
            'from_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'fromuser'", 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '11'}),
            'to_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'touser'", 'to': u"orm['auth.User']"})
        },
        u'mn.node': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 2, 0, 0)', 'blank': 'True'}),
        ...
        u'mn.reply': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_touched': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 2, 0, 0)', 'blank': 'True'}),
        ...
        u'mn.topic': {
            ...
            'last_replied_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 2, 0, 0)', 'blank': 'True'}),
            'last_touched': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 2, 0, 0)', 'blank': 'True'}),
        ...
        u'mn.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 2, 0, 0)', 'blank': 'True'}),
