...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Follow'
        db.create_table(u'mn_follow', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('followed', self.gf('django.db.models.fields.related.ForeignKey')(related_name='followed_user', to=orm['auth.User'])),
            ('follower', self.gf('django.db.models.fields.related.ForeignKey')(related_name='follower_user', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 7, 2, 0, 0), blank=True)),
        ))
        db.send_create_signal(u'mn', ['Follow'])


    def backwards(self, orm):
        # Deleting model 'Follow'
        db.delete_table(u'mn_follow')
