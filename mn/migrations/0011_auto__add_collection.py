...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mn_collection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='owneruser', to=orm['auth.User'])),
            ('owner_user_topic', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ownerusertopic', to=orm['mn.Topic'])),
            ('created', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 7, 2, 0, 0), blank=True)),
        ))
        db.send_create_signal(u'mn', ['Collection'])


    def backwards(self, orm):
        # Deleting model 'Collection'
        db.delete_table(u'mn_collection')
    ...
    models = {
        ...
        u'mn.collection': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'owneruser'", 'to': u"orm['auth.User']"}),
            'owner_user_topic': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ownerusertopic'", 'to': u"orm['mn.Topic']"})
        },
        u'mn.follow': {
